...
export default function TodoScreen({ navigation }) {
  ...
  function handleReposition({ data: draggableItems, from, to }) {
    console.log("setdraggableitems", draggableItems);
              ...
              >
                <View style={{ flex: 1 }}>
                  <View
                    style={[
                      {
                        backgroundColor: needAlert ? "#dc2626" : "white",
                        position: "absolute",
                        margin: 5,
                        right: 0,
                        top: 0,
                  ...
                  >
                    {needAlert ? (
                      <Text style={needAlert ? { color: "white" } : null}>
                        {TODOs.length}
                      </Text>
                    ) : (
                  ...
                  <DraggableFlatList
                    ...
                    data={draggableItems}
                    onDragEnd={(datas) => handleReposition(datas)}
                    keyExtractor={(item) => {
                      return item.key;
                    }}
