...
//     text: `Kencing`,
//     key: `key-0`,
//     backgroundColor: getColor(0, 4),
//     height: 75,
//   },
//   {
//     text: `Solat`,
//     key: `key-1`,
//     backgroundColor: getColor(1, 4),
//     height: 75,
//   },
//   {
//     text: `Minum`,
//     key: `minum`,
//     backgroundColor: getColor(2, 4),
//     height: 75,
//   },
//   {
//     text: `Tidur`,
//     key: `key-3`,
//     backgroundColor: getColor(3, 4),
//     height: 75,
//   }
// ];

export default React.forwardRef(function Basic(
  { modalVisible, setModalVisible, newTODO, setNewTODO },
  ref
) {
  // return (<View></View>)
  ...
  const renderItem = (params) => {
    return (
      ...
      >
        <View>
          <SwipeableButton {...params} deleteTODO={deleteTODO} />
        </View>
      </PinchGestureHandler>
    );
  };
